...
# -*- coding: utf-8 -*-
"""
ACMOJ API Client Command Line Tool - `.mv` File Submission Version v2.2

Usage Examples:
1. Submit `.mv` file:
   python3 acmoj_client.py --token ${ACMOJ_TOKEN} submit --problem-id ${ACMOJ_PROBLEM_ID} --language mov --code-file 2077.mv
